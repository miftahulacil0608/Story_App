...
import com.example.storyapp.ui.viewModel.StoryActivityViewModel
...
class StoryActivity : AppCompatActivity() {
    ...
    private lateinit var storyActivityViewModel : StoryActivityViewModel
    ...
    private fun setupViewModel(){
        storyActivityViewModel = ViewModelProvider(this)[StoryActivityViewModel::class.java]
